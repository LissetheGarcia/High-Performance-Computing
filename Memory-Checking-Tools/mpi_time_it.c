...
// mpi compile: mpicc -g mpi_time_it.c -o mpi_time_it
// valgrind compile: mpirun -n 2 valgrind --leak-check=full --show-leak-kinds=all --track_origins=yes --log-file="mpi_valgrind_memcheck.log" ./mpi_time_it
// Set var to avoid mpi warnings: PMIX_MCA_pcompress_base_silence_warning=1
